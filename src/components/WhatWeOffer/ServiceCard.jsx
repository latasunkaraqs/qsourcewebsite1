...
const ServiceCard = ({ image: Image, title, solutions }) => {
  return (
    <div className="group border border-[#0085F6] rounded-[20px] pt-6 flex flex-col items-center justify-center bg-[#0085F6] width-[320px] md:h-[770px]">
      <div className="flex flex-col flex-1 w-full justify-start items-start px-6">
        ...
        <h3
          title={title}
          className="w-full md:h-[80px] mt-5 text-white font-onest text-[28px] font-bold leading-[115%] tracking-normal "
        >
          {title}
        </h3>
      </div>
