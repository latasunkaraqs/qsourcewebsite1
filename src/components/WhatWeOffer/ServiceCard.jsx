...
const ServiceCard = ({ image: Image, title, solutions }) => {
  return (
    <div className="group border border-[#0085F6] rounded-[20px] pt-6 flex flex-col gap-5 items-center justify-center bg-[#0085F6] width-[320px]">
      ...
      <h3
        title={title}
        className="w-full px-6 text-white font-onest text-[28px] font-bold leading-[100%] tracking-[-0.03em] lg:whitespace-nowrap lg:overflow-hidden lg:text-ellipsis"
      >
        {title}
      </h3>
