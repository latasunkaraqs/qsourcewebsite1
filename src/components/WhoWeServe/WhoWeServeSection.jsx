...
import industry1 from "../../assets/industries.jpg";
import industry2 from "../../assets/government.jpg";
import industry3 from "../../assets/commercial.jpg";
import industry4 from "../../assets/engineering.jpg";

const WhoWeServeSection = () => {
  return (
    <div className="max-w-[1440px] mx-auto flex flex-col py-8 items-center justify-center gap-5 px-6 md:px-10 ">
      <h2 className="font-onest text-[40px] md:text-[56px] lg:text-[60px] font-bold leading-[100%] tracking-normal text-[#021933] text-center">
        Who We <span className="text-[#0085F6]">Serve</span>
      </h2>

      <p className="font-onest text-[20px] font-medium leading-[130%] tracking-normal text-[#021933] text-center max-w-[90%]">
...
const tabs = [
  ...
  {
    id: 4,
    backgroundImage: industry4, // Image Missing
    label: "Emerging & Specialized Sectors",
    content:
      "Organizations operating in evolving, purpose-driven, or innovation-led environments with unique constraints, funding models, and growth trajectories.",
