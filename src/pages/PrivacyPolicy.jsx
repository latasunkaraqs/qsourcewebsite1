...
const PrivacyPolicy = () => {
  ...
  return (
    <>
      <Helmet>
        <title>QSource Group Inc. | Privacy Policy</title>
        <meta
          name="description"
        ...
        <div className="max-w-4xl mx-auto font-onest bg-white shadow-2xl rounded-2xl border border-gray-200 p-10 space-y-8 leading-relaxed">
          ...
          <Section title="1. Scope & Applicability">
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                Individuals submitting inquiries, forms, or communications
              </li>
          ...
          <Section title="2. Information We Collect">
            ...
            <p className="mt-2">
              This data supports security, analytics, and performance
              improvement.
            </p>
          ...
          <Section title="3. How We Use Information">
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                Communicate regarding services, solutions, or opportunities
              </li>
          ...
          <Section title="7. Data Security">
            <p>
              ...
              designed to protect information from unauthorized access, loss, or
              misuse. No system can be guaranteed completely secure.
            </p>
          </Section>
          ...
          <Section title="8. International Data Transfers">
            <p>
              ...
              QSource or its service providers operate. Appropriate safeguards
