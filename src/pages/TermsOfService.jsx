...
const TermsOfService = () => {
  ...
  return (
    <>
      <Helmet>
        <title>QSource Group Inc. | Terms of Service</title>
        <meta
          name="description"
        ...
        <div className="max-w-4xl mx-auto font-onest bg-white shadow-2xl rounded-2xl border border-gray-200 p-10 space-y-8 leading-relaxed">
          ...
          <div className="space-y-2">
            ...
            <p>
              ...
              website operated by QSource Group Inc. (“QSource,” “Company,”
              “we,” “our,” or “us”). By accessing or using this website, you
              agree to be bound by these Terms. If you do not agree, you should
          ...
          <Section title="1. Scope & Applicability">
            <p>
              ...
              website. These Terms govern only website usage and do not replace
              or override any contractual agreements executed separately with
              QSource.
            </p>
          </Section>
          ...
          <Section title="2. Website Purpose">
            <p>
              ...
              related to QSource's services, solutions, industry experience, and
              corporate information. Content on this website does not constitute
          ...
          <Section title="3. Eligibility and Acceptable Use">
            <p>
              ...
              misuse the website or attempt to disrupt its operation, security,
              or integrity.
            </p>
          </Section>
          ...
          <Section title="4. Intellectual Property Rights">
            <p>
              ...
              icons, images, layout, and design, is the property of QSource
              Group Inc. or its licensors and is protected by intellectual
              property laws. Unauthorized use, reproduction, modification, or
              distribution is prohibited without prior written consent.
            </p>
          </Section>

          <Section title="5. User Submissions">
            <p>
              Any information or materials submitted through this website must
              be accurate and lawful. By submitting information, you grant
              QSource the right to use such information for legitimate business
          ...
          <Section title="6. Third-Party Links">
            <p>
              ...
              convenience. QSource does not control or endorse third-party
              content and is not responsible for their practices, content, or
              policies.
            </p>
          </Section>
          ...
          <Section title="9. Limitation of Liability">
            <p>
              To the fullest extent permitted by law, QSource Group Inc. shall
              not be liable for any direct, indirect, incidental, consequential,
              or special damages arising from use of or inability to use this
              website.
            </p>
          </Section>
          ...
          <Section title="10. Indemnification">
            <p>
              ...
              liabilities arising from misuse of the website or violation of
              these Terms.
            </p>
          </Section>
          ...
          <Section title="11. Security">
            <p>
              ...
              interfere with website systems. Violations may result in
              restricted access or legal action.
            </p>
          </Section>

          <Section title="12. Privacy">
            <p>
              Use of this website is subject to the QSource Privacy Policy,
              which describes how personal information is collected and
              processed.
            </p>
          </Section>
          ...
          <Section title="13. Governing Law">
            <p>
              ...
              with the laws of the jurisdiction in which QSource Group Inc. is
